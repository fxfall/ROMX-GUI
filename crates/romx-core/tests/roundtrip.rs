use romx_core::{pack_bytes, read_bytes, FLAG_BODY_SHA256, FLAG_COVER, FLAG_METADATA};
use serde_json::json;
...
fn roundtrip_preserves_rom_metadata_and_png() {
    ...
    assert_eq!(document.footer.flags & (FLAG_METADATA | FLAG_COVER | FLAG_BODY_SHA256), FLAG_METADATA | FLAG_COVER | FLAG_BODY_SHA256);
}

#[test]
fn rejects_overlapping_regions() {
    let metadata = json!({"schema_version":"1.0","label":"x","platform":"gba","payload_format":"gba"});
